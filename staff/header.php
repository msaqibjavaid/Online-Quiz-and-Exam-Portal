...
<head>
  ...
  <title>Quiz and Exam Portal | Staff Dashboard</title>
  ...
  <link rel="stylesheet" href="../admin/style/bootstrap-4.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="../admin/style/jqvmap.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="../admin/style/adminlte.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="../admin/style/OverlayScrollbars.min.css">
  <link rel="stylesheet" type="text/css" href="../admin/style/forms.css">
    <link rel="stylesheet" type="text/css" href="../admin/style/custom.css">
